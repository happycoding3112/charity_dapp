...
const ViewFile = () => {
  ...
  return (
    <div className='fixed top-0 left-0 flex justify-center items-center h-screen w-screen py-4'>
      <div className='h-full w-3/5 bg-gray-700 rounded-md pb-10'>
        ...
        <Viewer plugins={[defaultLayoutPluginInstance]} fileUrl={"/uploads/" + doc} />
      </div>
    </div>
  )
}
